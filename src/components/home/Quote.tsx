...
const Quote = (props: { rand: number }): JSX.Element => {
  ...
  return (
    <motion.div
      ...
      className="font-serif flex flex-col justify-center items-center w-full mt-8 px-2 hover:cursor-pointer max-w-sm sm:max-w-lg md:max-w-2xl lg:max-w-4xl xl:max-w-6xl text-gray-50"
      onClick={() => {
        handleChangeQuote();
      }}
      id="quote"
    >
      <span className="text-sm md:text-lg xl:text-xl italic text-center" >
